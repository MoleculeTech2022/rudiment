...
if($_POST['fname'] && $_POST['mname'] && $_POST['lname'] && $_POST['faname'] && $_POST['moname'] && $_POST['fcontact'] && $_POST['mcontact'] && $_POST['school'] && $_POST['forclass']){
	...
	$stmt = $conn->prepare("INSERT INTO `marketing`(`fname`, `mname`, `lname` , `faname` , `moname`, `fcontact`, `mcontact`, `school`, `forclass`) VALUES (?,?,?,?,?,?,?,?,?)");
	$stmt->bind_param("sssssssss",$fname,$mname,$lname,$faname,$moname,$fcontact,$mcontact,$school,$forclass);
