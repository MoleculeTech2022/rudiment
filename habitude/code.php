...
if(isset($_POST['add_notes_btn'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO i_upsc_notes (subject, subtopic, note, date, chapter) VALUES (?, ?, ?, ?, ?)");
...
if(isset($_POST['insert_btn'])) {
    ...
    // Prepare and bind the SQL statement
    $stmt = $conn->prepare("INSERT INTO quiz (subject, subtopic, question, option_one, option_two, option_three, option_four, answer, explanation, chapter, level) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
