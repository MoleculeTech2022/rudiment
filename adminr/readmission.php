                    ...
                    <script>
                        $(document).ready(function () {
                            $("#search").on("keyup", function () {
                                ...
                                $.ajax({
                                    url: "readmission_search_filter.php",
                                    method: "POST",
                    ...
                    <div class="container">
                        ...
                        <div class="students-page-contents" style="margin-top:-20px;">
                            <span style="margin-left:290px;font-size:12px;">Rudiment / <i class="fa fa-home"></i> /
                                ReAdmission</span><br>
                            <span style="font-size:35px;margin-left:290px;margin-top:20px;">ReAdmission</span><br>
                            <span style="margin-left:290px;margin-top:20px;font-size: 12px;">ReAdmission manage here.</span>
                        ...
                        <div class="filter-select-box" style="margin-top: -36px; margin-left: 560px;">
                            <select name="academic_year" id="academic_year"
                                style="width: 150px; height: 35px; padding: 5px; border: 1px solid #edeaea; border-radius: 5px;">
                    ...
                    <script>
                        $(document).ready(function () {
                            ...
                            function updateStudentTable(selectedYear) {
                                $.ajax({
                                    url: "readmission_acd_filter.php",
                                    method: "POST",
