...
<body>
  ...
  <div class="dashboard-contents"
    ...
    <h3 style="text-align:center;margin-left:340px;">Admission Form</h3>
    <div class="student-admission-form"
      ...
      <form action="code.php" method="POST">
        ...
        <div class="student-details">
          ...
          <input type="text" name="fname" required placeholder="Student First Name"
            style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">

          <input type="text" name="mname" id="mname" required placeholder="Student Middle Name"
            oninput="autoFillFaname()"
            style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
          <div class="third-input" style="margin-left:520px;margin-top:-51px;">

            <input type="text" name="lname" required placeholder="Student Last Name"
          ...
          <select name="classAdmitted" placeholder="Student Student Class"
            ...
            <option value="class not selected">Select Applied Class</option>
            <option value="Play Group">Play Group</option>
            <option value="NUR">Nursery</option>
            <option value="LKG">LKG</option>
            <option value="UKG">UKG</option>
            <option value="UKGP">UKG P</option>
            <option value="Other">Other</option>
          </select>
          <input type="number" name="saadhar" placeholder="Student Aadhar No"
            style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">

          <select type="number" name="religion"
            style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
          ...
          <input type="text" name="caste" placeholder="Student Caste"
            style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
        ...
        <div class="parents-details">
          <input type="text" name="faname" id="faname" required placeholder="Father Name"
            style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
          ...
          <input type="text" name="local_addr" placeholder="Local Address"
            style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
        ...
        <div class="title"
          style="margin-top:20px;width:97%;height:25px;background-color:#40e0d0;padding:10px;margin-left:30px;">
          <div class="title-2" style="margin-top:-10px;">
            <span style="margin-left:30px;margin-top:-30px;color:#fff;">Payment Details</span>
          </div>
        </div>
        ...
        <div class="update-student-details-div"
          ...
          <input type="number" name="total_fees" required placeholder="Total Fees"
          ...
          <input type="date" name="doa" title="Date of Admission" placeholder="Student Academic Year"
            style="margin-left:0px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">


          <input type="number" name="payamt" required placeholder="Admission Fee"
            style="margin-left:20px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">

          <input type="textarea" name="fees_plan" placeholder="Fees Plan"
            style="margin-left:0px;margin-top:20px;padding:5px;width:450px;border-radius:5px;border-width:1px;">
          <br>

          <input type="textarea" name="fees_title" placeholder="Fees Title"
            style="margin-left:0px;margin-top:20px;padding:5px;width:450px;border-radius:5px;border-width:1px;">
          <br>
          <select name="paymode" id="paymode" placeholder="Payment Mode"
            style="margin-left:0px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
            <option value="Payment Mode Not Selected">Select Payment Mode</option>
            <option value="Cash">Cash</option>
            <option value="Account">Account</option>
          </select>
          <br>
          <button class="update-student-details" name="add_button" value="submit"
  ...
  <!-- // Automatically faname filled by mname -->
  <script>
    function autoFillFaname() {
      var mnameValue = document.getElementById("mname").value;
      document.getElementById("faname").value = mnameValue;
    }
  </script>
