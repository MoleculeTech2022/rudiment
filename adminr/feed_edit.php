...
if (isset($_GET['sid'])) {
  ...
  <div class="navbar" style="margin-left:261px;width:80%;height: 70px;position: absolute;background-color: rgb(241, 246, 251);display: flex;">
      ...
      <div class="academic-year-filter" style="margin-top:-17px;margin-left:10px;">
        <select name="academic_year" id="academic_year" style="width:90px;height:30px;padding:5px;border:none;border-radius:20px;margin-left:70px;margin-top:-30px;">
      ...
      <div class="search-bar">
          <input type="search" placeholder="Search Your Student..." id="search" name="search" style="width:300px;height:35px;margin-top:17px;border: none;border-radius: 20px;padding:10px;margin-left:110px;">
      </div>
      ...
      <div class="log-out-btn" style="margin-left:20px;margin-top:20px;">
          <button style="width:130px;height: 30px;background-color:#ff0000;border-width: 1px;border-radius: 20px;">LOG-OUT</button>
      </div>
  </div>
  <div class="dashboard-contents"
    style="margin-left:261px;width:900px;height:700px;background-color: #ffffff ;position: absolute;margin-top: 71px;">

  <div class="student-card" style="position:absolute;width:900px;height:80px;background-color:#fff;box-shadow:1px 1px 1px 1px #edeaea;margin-top:20px;margin-left:20px;border-radius:10px; ">
  <a href="student-view.php?sid=<?php echo $feedback['sid'] ?>" style="text-decoration:none;">
    <span style="display: block; margin-top: 20px;margin-left:20px;">Student Name : <?php echo  $feedback['fname']; ?> <?php echo  $feedback['mname']; ?> <?php echo  $feedback['lname']; ?></span>
  </a>
  <span style="display: block; margin-top: -23px;margin-left:350px;">Class : <?php echo  $feedback['classAdmitted']; ?></span>
  <span style="display: block; margin-top: -23px;margin-left:470px;">Academic Year : <?php echo  $feedback['acdyear']; ?></span>
</div>
...
<form action="code.php" method="POST">
             ...
             <input type="date" name="feeddate" value="<?php echo $feedback['feeddate']; ?>" id="feeddate" placeholder="Feedback Date"
             ...
             <select name="feedteacher" placeholder="Sub Teacher"
               style="margin-left:20px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
               <option value="<?php echo $feedback['feedteacher']; ?>"><?php echo $feedback['feedteacher']; ?></option>
             ...
             <select name="feedtitle" placeholder="Feedback Title"
               style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
               <option value="<?php echo $feedback['feedtitle']; ?>"><?php echo $feedback['feedtitle']; ?></option>
