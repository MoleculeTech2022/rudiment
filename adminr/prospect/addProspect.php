...
<head>
    ...
    <title>RUDIMENT - New Prospect Admission</title>
    <!-- CSS -->
...
<body>
    ...
    <div class="dashboard-contents"
            ...
            <form action="prospectdbcode.php" method="POST">
                ...
                <div class="student-details">
                    ...
                    <div class="third-input" style="margin-left:520px;margin-top:-51px;">
                        ...
                        <input type="number" name="mcontact" required placeholder="Mother Contact *" title="Mother Contact"
                            style="margin-left:0px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
                    </div>

                    <input type="number" name="fcontact" title="Father Contact" placeholder="Father Contact *"
                        style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
        ...
        <option value="class 4">Class 4</option> -->
                    ...
                    <input type="text" name="ref" placeholder="Refrrence *" required
                        style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
                ...
                <div class="parents-details">
                    <input type="text" name="faname" required placeholder="Father Name"
                        style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
                    ...
                    <div class="third-input" style="margin-left:520px;margin-top:-51px;">
                    <input type="text" name="fsalary" placeholder="Father Salary" id="fsalary"
                        style="margin-left:0px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
                   </div>

                    <input type="text" name="moname" required placeholder="Mother Name"
                        style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
                    ...
                    <div class="third-input" style="margin-left:520px;margin-top:-51px;">
                    <input type="text" name="msalary" placeholder="Mother Salary" id="msalary"
                        style="margin-left:0px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">
                ...
                <div class="update-student-details-div"
                    ...
                    <input type="date" name="dov" title="Date Of Visit *" required
