...
if (isset($_GET['expid'])) {
    $expCatgid = mysqli_real_escape_string($con, $_GET['expid']);
    $query = "SELECT * FROM expense JOIN expensecategory ON expense.expid = expensecategory.expCatgid WHERE expense.expid = $expid";
    ...
    if (mysqli_num_rows($query_run) > 0) {
        ...
        <head>
            ...
            <title>RUDIMENT - Expense Edit</title>
        </head>
        ...
        <body>
            ...
            <div class="dashboard-contents"
                ...
                <form action="expcode.php" method="POST" style="margin-top:5px;">
                    ...
                    <input type="hidden" name="expCatgid" value="<?= $exp['expCatgid']; ?>">

                    <input type="number" name="expAmt" value="<?= $exp['expAmt']; ?>" placeholder="Your Amount"
                        style="margin-left:30px;margin-top:20px;padding:5px;width:210px;border-radius:5px;border-width:1px;">

                    <input type="date" name="expDate" value="<?= $exp['expDate']; ?>" id="paydate"
