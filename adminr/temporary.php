...
WHERE classAdmitted = 'UKG' AND acdyear.acdyear = '$default_acdyear'";
        $lkg = "SELECT COUNT(*) AS lkg_count FROM students 
JOIN acdyear ON students.sid = acdyear.sid
WHERE classAdmitted = 'LKG' AND acdyear.acdyear = '$default_acdyear'";
        $nur = "SELECT COUNT(*) AS nur_count FROM students 
JOIN acdyear ON students.sid = acdyear.sid
WHERE classAdmitted = 'NUR' AND acdyear.acdyear = '$default_acdyear'";
                ...
                <body style="background-color: #f2f4f6;">
                    <div class="container">
                        ...
                        <div class="students-page-contents" style="margin-top:-20px;">
                            <span style="margin-left:290px;font-size:12px;">Rudiment / <i class="fa fa-home"></i> / Temporary</span><br>
                            <span style="font-size:35px;margin-left:290px;margin-top:20px;">Temporary Work</span><br>
                            <span style="margin-left:290px;margin-top:20px;font-size: 12px;">All Rudiment temporary work manage
                                here.</span>

                        </div>
                        <div class="buttons" style="margin-left:990px;margin-top:-90px;">
                            <a href="temp_add.php" style="text-decoration:none;">
                                <button
                            ...
                            <a href="students.php">
                                <button
                                    style="height:40px;width:130px;margin-top:20px;margin-left:10px;background-color:rgb(100, 193, 255);color:#fff;border:none;border-radius: 5px;">Students</button>
                            </a>
                        </div>
                        ...
                        <div class="table" id="student-table" style="margin-left: 30px;;">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    JOIN temporary ON students.sid = temporary.sid
                                    ...
                                    if (mysqli_num_rows($resultFetchStudents) > 0) {
                                        while ($rows = mysqli_fetch_assoc($resultFetchStudents)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $rows['text_one']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $rows['text_two']; ?>
                                                </td>

                                                <td>
                                                    <?php echo $rows['text_three']; ?>
                                                </td>

                                                <td>
                                                    <a href="temp_view.php?sid=<?php echo $rows['temp_id']; ?>" style="text-decoration:none;">
                                                        <i class="bx bx-id-card" style="margin-left:15px;"></i>
                                                    </a>
                                                    <a href="temp_edit.php?temp_id=<?php echo $rows['temp_id']; ?>">
                    ...
                    <!-- <script>
                        ...
                        // $default_acdyear = $year['default_acdyear'];
                        ?>
                        updateStudentTable("<?php
                        // echo $default_acdyear;
                        ?>");
                        // updateStudentTable("2023-24");
                        // updateStudentTable("2024-25");
